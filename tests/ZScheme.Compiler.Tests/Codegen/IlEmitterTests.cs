...
public class IlEmitterTests
{
    ...
    [
        (
            "OptionModule",
            [
                new IrNode.UnionDecl(
                    "Option",
                    ["a"],
                    [
                        new IrUnionCase(
                            "Some",
                            [new IrField("value", new ZType.ZNamedType("a", []))]
                        ),
            ...
            [
                new IrNode.UnionDecl(
                    ...
                    [
                        ...
                        new IrUnionCase(
                            "Err",
                            [new IrField("error", new ZType.ZNamedType("e", []))]
                        ),
                    ]
                ),
            ]
            ...
            [
                new IrNode.RecordDecl(
                    ...
                    [
                        ...
                        new IrField(
                            "inner",
                            new ZType.ZNamedType("Option", [new ZType.ZNamedType("Error", [])])
                        ),
                    ]
                ),
            ]
    ...
    public void EmitCallToUserDefinedFunction()
    {
        ...
        var mainFunc = new IrNode.FuncDef("Main", [], ZType.Int, callAdd, false)
        {
            Type = new ZType.ZFuncType([], ZType.Int),
        };
    ...
    public void EmitLetBinding()
    {
        ...
        var func = new IrNode.FuncDef("GetFortyTwo", [], ZType.Int, body, false)
        {
            Type = new ZType.ZFuncType([], ZType.Int),
        };
    ...
    public void EmitBoolOperations()
    {
        ...
        var func = new IrNode.FuncDef("AndOp", [], ZType.Bool, body, false)
        {
    ...
    public void EmitRecordDecl_RuntimeEquals_Works()
    {
        ...
        var record = new IrNode.RecordDecl("Pt", [], [new IrField("x", ZType.Int)]);
        var diag = new DiagnosticBag();
    ...
    public void EmitUnionCaseNew_GenericMultipleTypeArgs()
    {
        ...
        var func = new IrNode.FuncDef(
            ...
            [],
            resultType,
            new IrNode.UnionCaseNew("Result", "Ok", [new IrNode.IntConst(1) { Type = ZType.Int }])
            {
                Type = resultType,
            },
            false
    ...
    public void EmitUnionCaseNew_GenericNestedTypeArg()
    {
        ...
        var nestedType = new ZType.ZNamedType(
            "Option",
            [new ZType.ZNamedType("Option", [ZType.Int])]
        );
        var func = new IrNode.FuncDef(
            "test",
            [],
    ...
    public void EmitUnaryNot()
    {
        var func = new IrNode.FuncDef(
            ...
            ZType.Bool,
            new IrNode.UnaryOp("not", new IrNode.Var("x") { Type = ZType.Bool })
            {
                Type = ZType.Bool,
            },
            false
    ...
    public void EmitStructFieldGet_ViaPropertyMethodCall_UsesCallNotCallvirt()
    {
        ...
        var structDecl = new IrNode.RecordDecl(
            "FRec",
            [],
            [new IrField("first", ZType.Int), new IrField("second", ZType.Int)],
            IsValueType: true
        );
    ...
    public void EmitMatchOnGenericStruct_BindsFieldViaCallOnAddress()
    {
        ...
        var scrutinee = new IrNode.RecordNew(
            "FRec",
            [
            ...
            new IrNode.Let(
                ...
                new IrNode.FuncDef(
                    ...
                    new IrNode.BinOp(
                        "+",
                        new IrNode.Var("x") { Type = ZType.Int },
                        new IrNode.Var("captured") { Type = ZType.Int }
                    )
                    {
                        Type = ZType.Int,
                    },
    ...
    {
        var computeAsync = new IrNode.FuncDef(
            "compute-async",
            [new IrParam("x", ZType.Int)],
            ZType.Int,
            new IrNode.BinOp(
        ...
        var fetchAndAdd = new IrNode.FuncDef(
            "fetch-and-add",
            [new IrParam("x", ZType.Int)],
            ZType.Int,
            new IrNode.Let(
    ...
    {
        var baseDecl = new IrNode.ClassDecl(
            "Animal",
            [],
            [],
    ...
    public void EmitClassDecl_Inheritance()
    {
        ...
        var subDecl = new IrNode.ClassDecl(
            "Dog",
            [],
            [],
    ...
    {
        var ifaceDecl = new IrNode.InterfaceDecl(
            "IGreeter",
            [],
            [],
            [
        ...
        var bytes = emitter.Emit(new ObjectLifter().Lift(seq));
    ...
    {
        var iface1 = new IrNode.InterfaceDecl(
            "IFoo",
            [],
            [],
            [new IrInterfaceMethodSignature("Foo", [], ZType.Int)]
        );
        var iface2 = new IrNode.InterfaceDecl(
            "IBar",
            [],
            [],
    ...
    public void EmitObjectExpr_WithBaseClassAndConstructorSuper()
    {
        ...
        var objectExpr = new IrNode.ObjectExpr([], [], "Animal", irCtor)
        {
            Type = new ZType.ZNamedType("Animal", []),
        };
    ...
    public void EmitObjectExpr_WithBaseClassAndSuperArgsReferencingOuterParam()
    {
        ...
        var objectExpr = new IrNode.ObjectExpr([], [], "Animal", ctor)
        {
            Type = new ZType.ZNamedType("Animal", []),
        };
    ...
    public void EmitObjectExpr_MethodInvokesCapturedDelegateParam()
    {
        ...
        var typeNames = mdReader
            .TypeDefinitions.Select(h => mdReader.GetString(mdReader.GetTypeDefinition(h).Name))
            .ToList();
    ...
    public void EmitObjectExpr_MethodInvokesCapturedDelegateLocal()
    {
        ...
        var letBody = new IrNode.Let("f", new IrNode.Var("g") { Type = fnIntInt }, objectExpr)
        {
            Type = new ZType.ZNamedType("IFoo", []),
        };
    ...
    {
        var baseIface = new IrNode.InterfaceDecl(
            "IBase",
            [],
            [],
        ...
        var childIface = new IrNode.InterfaceDecl(
            "IChild",
            [],
            ["IBase"],
    ...
    public void EmitMethodCall_IndexerSet()
    {
        ...
        var func = new IrNode.FuncDef(
            ...
            ZType.Unit,
            new IrNode.MethodCall(
                new IrNode.MutableArrayNew(ZType.Int, [new IrNode.IntConst(0) { Type = ZType.Int }])
                {
                    Type = arrType,
                },
                "Set",
        ...
        var outer = new IrNode.FuncDef(
            ...
            new IrNode.FuncDef(
                ...
                new IrNode.BinOp(
                    "*",
                    new IrNode.Var("x") { Type = ZType.Int },
                    new IrNode.Var("factor") { Type = ZType.Int }
                )
                {
                    Type = ZType.Int,
                },
    ...
    public void AsyncMultipleAwait_EmitsStateMachine()
    {
        ...
        var doubleCompute = new IrNode.FuncDef(
            "double-compute",
            [new IrParam("x", ZType.Int)],
            ZType.Int,
            new IrNode.Let(
    ...
    public void AsyncNestedAwaitInsideArg_EmitsStateMachine()
    {
        ...
        var outerAwait = new IrNode.Await(
            new IrNode.Call(new IrNode.Var("g") { Type = fnTy }, [innerAwait]) { Type = TaskInt }
        )
        {
            Type = ZType.Int,
        };
    ...
    public void EmitSyncAwait_TaskOfInt()
    {
        ...
        var syncCaller = new IrNode.FuncDef(
            "sync-caller",
            [new IrParam("x", ZType.Int)],
            ZType.Int,
            new IrNode.Await(
    ...
    public void EmitSyncAwait_TaskUnit()
    {
        ...
        var doWorkAsync = new IrNode.FuncDef(
            "do-work-async",
            [],
            ZType.Unit,
            new IrNode.UnitConst { Type = ZType.Unit },
        ...
        var syncCaller = new IrNode.FuncDef(
            ...
            new IrNode.Await(
                new IrNode.Call(
                    new IrNode.Var("do-work-async") { Type = new ZType.ZFuncType([], TaskUnit) },
                    []
                )
                {
                    Type = TaskUnit,
    ...
    public void EmitWithHandlers_MultipleClauses_HandlerRegionsAreContiguous()
    {
        ...
        foreach (var typeHandle in mdReader.TypeDefinitions)
        {
            ...
            foreach (var methodHandle in typeDef.GetMethods())
            {
                ...
                if (mdReader.GetString(method.Name) != "MultiCatch")
                    continue;
    ...
    public void EmitWithHandlers_ThreeClauses_HandlerRegionsAreContiguous()
    {
        ...
        foreach (var typeHandle in mdReader.TypeDefinitions)
        {
            ...
            {
                var method = mdReader.GetMethodDefinition(methodHandle);
                if (mdReader.GetString(method.Name) != "TripleCatch")
                    continue;
                body = peReader.GetMethodBody(method.RelativeVirtualAddress);
                break;
            }
    ...
    public void EmitWithHandlers_ManyClausesStillCatchAtRuntime()
    {
        ...
        foreach (var typeHandle in mdReader.TypeDefinitions)
        {
            ...
            {
                var method = mdReader.GetMethodDefinition(methodHandle);
                if (mdReader.GetString(method.Name) != "Compute")
                    continue;
        ...
        Assert.True(
            methodBody!.ExceptionRegions.Length >= N,
    ...
    public void EmitDelegateInvoke_NonVarExpression()
    {
        ...
        )
        {
            Type = new ZType.ZFuncType(
                [new ZType.ZFuncType([ZType.Int], innerFuncType), ZType.Int],
                ZType.Int
            ),
        };
    ...
    public void EmitClrCall_FallsBackToStaticField_EnumValue()
    {
        ...
        var clrCall = new IrNode.ClrCall("System.DayOfWeek", "Friday", [])
        {
    ...
    public void EmitClrCall_FallsBackToStaticField_StaticReadonly()
    {
        ...
        var clrCall = new IrNode.ClrCall("System.String", "Empty", []) { Type = ZType.String };

        var func = new IrNode.FuncDef("GetEmpty", [], ZType.String, clrCall, false)
        {
            Type = new ZType.ZFuncType([], ZType.String),
        };
    ...
    public void EmitMatchWithMixedArmTypes_SetFieldAndNull()
    {
        ...
        var setField = new IrNode.SetField("value", new IrNode.Var("v") { Type = ZType.Int })
        {
            Type = ZType.Unit,
        };
        ...
        var matchExpr = new IrNode.Match(
            ...
            [
                ...
                new IrMatchArm(new IrPattern.Wildcard(), nullConst),
            ]
        )
        {
            Type = ZType.Unit,
        ...
        var optionDecl = new IrNode.UnionDecl(
            "Option",
            ["a"],
            [
                new IrUnionCase("Some", [new IrField("value", new ZType.ZNamedType("a", []))]),
    ...
    public void EmitClassDecl_MethodWithLocals_EmitsSuccessfully()
    {
        ...
        var classDecl = new IrNode.ClassDecl("Calculator", [], [], [], [method]);
    ...
    public void EmitClassMethod_ReturningBoxedValueType_EmitsSuccessfully()
    {
        ...
        var classDecl = new IrNode.ClassDecl("Boxer", [], [], [], [method]);
    ...
    public void EmitClrCall_StaticProperty_EmitsSuccessfully()
    {
        ...
        var clrCall = new IrNode.ClrCall("System.Threading.Tasks.Task", "CompletedTask", [])
        {
            Type = taskType,
        };

        var func = new IrNode.FuncDef("GetCompletedTask", [], taskType, clrCall, false)
        {
    ...
    public void EmitMatch_GenericUnionFromImportedModule_EmitsSuccessfully()
    {
        ...
        var seq = new IrNode.Seq([func]) { Type = ZType.Unit };
        var diag = new DiagnosticBag();
        var emitter = new IlEmitter("TestAssembly", diag, "TestClass", importedModules: modules);
        var bytes = emitter.Emit(seq);
    ...
    public void EmitOutParamMethodCall_InstanceTryGetValue()
    {
        ...
        var outParams = new List<ClrInterop.OutParamInfo> { new(1, ZType.Int) };
    ...
    {
        var doubleMethod = new IrObjectMethod(
            "double",
            [new IrParam("x", ZType.Int)],
            ZType.Int,
            new IrNode.BinOp(
        ...
        var quadrupleMethod = new IrObjectMethod(
            "quadruple",
            [new IrParam("x", ZType.Int)],
            ZType.Int,
            new IrNode.Call(
    ...
    {
        var countdownMethod = new IrObjectMethod(
            "countdown",
        ...
        var classDecl = new IrNode.ClassDecl("Counter", [], [], [], [countdownMethod]);
    ...
    {
        var helperFunc = new IrNode.FuncDef(
            "helper",
            [new IrParam("x", ZType.Int)],
            ZType.Int,
            new IrNode.BinOp(
