...
// IsMutable marks `#:mutable` fields — the targets of the receiver form of `set!`
// generated by SetFieldExprGenerator.
public sealed record UserRecordField(string Name, string TypeParam, bool IsMutable = false);
