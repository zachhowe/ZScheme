...
public static class MacroSerializer
{
    ...
    private static JsonObject SerializePattern(MacroPattern pattern)
    {
        return pattern switch
        {
            ...
            MacroPattern.Variable v => new JsonObject { ["kind"] = "variable", ["name"] = v.Name },
            MacroPattern.Wildcard => new JsonObject { ["kind"] = "wildcard" },
            ...
            _ => throw new ArgumentException(
                $"Unknown MacroPattern variant: {pattern.GetType().Name}"
            ),
        };
    }
    ...
    private static JsonObject SerializePatList(MacroPattern.PatList pl)
    {
        ...
        return new JsonObject { ["kind"] = "patList", ["elements"] = elementsArray };
    }
    ...
    private static JsonObject SerializePatBracketList(MacroPattern.PatBracketList pbl)
    {
        ...
        return new JsonObject { ["kind"] = "patBracketList", ["elements"] = elementsArray };
    }
    ...
    private static JsonObject SerializeTemplate(MacroTemplate template)
    {
        return template switch
        {
            ...
            MacroTemplate.Variable v => new JsonObject { ["kind"] = "variable", ["name"] = v.Name },
            ...
            _ => throw new ArgumentException(
                $"Unknown MacroTemplate variant: {template.GetType().Name}"
            ),
        };
    }
    ...
    private static JsonObject SerializeTList(MacroTemplate.TList tl)
    {
        ...
        return new JsonObject { ["kind"] = "tList", ["elements"] = elementsArray };
    }
    ...
    private static JsonObject SerializeTBracketList(MacroTemplate.TBracketList tbl)
    {
        ...
        return new JsonObject { ["kind"] = "tBracketList", ["elements"] = elementsArray };
    }
    ...
    private static MacroTemplate DeserializeTemplate(JsonObject obj)
    {
        ...
        return kind switch
        {
            "datum" => new MacroTemplate.Datum(
                DeserializeSExpr(
                    obj["value"] ?? throw new ArgumentException("Missing 'value' in datum template")
                ),
                SourceSpan.None
            ),
    ...
    private static JsonObject SerializeSList(SExpr.SList sl)
    {
        ...
        return new JsonObject { ["kind"] = "sList", ["items"] = itemsArray };
    }
    ...
    private static JsonObject SerializeBracketList(SExpr.BracketList bl)
    {
        ...
        return new JsonObject { ["kind"] = "bracketList", ["items"] = itemsArray };
    }

    private static SExpr DeserializeSExpr(JsonNode node)
    {
        var obj =
            node as JsonObject ?? throw new ArgumentException("Expected a JSON object for SExpr");
