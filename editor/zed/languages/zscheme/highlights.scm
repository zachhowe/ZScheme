...
(list head: (symbol) @keyword
  (#match? @keyword "^(define-syntax|define-async|define|let\\*|let|if|fn|match|record|union|try|catch|with-handlers|\\?|begin|new|raise|await|class|interface|syntax-rules|and|or|not)$"))
