...
(list head: (symbol) @keyword
  (#match? @keyword "^(define-syntax|define-async|define-type-alias|define|let\\*|let|if|lambda|match|record|struct|union|with-handlers|with|set!|begin|new|raise|await|class|interface|syntax-rules|and|or|not|values)$"))
