...
(import-clr
  ...
  [builder-logging WebApplicationBuilder.Logging
    :instance-property : (WebApplicationBuilder -> ILoggingBuilder)])
...
(define (logging/clear-providers [builder : WebApplicationBuilder])
...
(define (logging/request-logger [ctx : HttpContext]
                                [category : String])
  : ILogger
...
(define (logging/app-logger [app : WebApplication]
                            [category : String])
  : ILogger
  (let ([factory : ILoggerFactory
