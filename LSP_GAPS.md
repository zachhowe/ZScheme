...
- Code actions — add missing match arms (ZS0002), add missing import (ZS0001), prefix-with-underscore + remove unused binding (ZS0003), simplify a redundantly qualified type name (ZS0004), replace a deprecated accessor spelling (ZS0006) or a deprecated form head (ZS0007) with its modern spelling (`CodeActionHandler`)
